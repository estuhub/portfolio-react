            ...
            <div className="skills-wrapper">
                <div className="skills-card">
                    ...
                    <div>
                        ...
                        <p className="skill-text">Currently working as a mentor for web dev students. Experience in developing web page efficiently using React, JavaScript, HTML and CSS.</p>
                ...
                <div className="skills-card">
                    ...
                    <div>
                        ...
                        <p className="skill-text">Worked as Data Analyst with +10 years of experience in the retail and multinational consumer goods companies. Extensively worked developing decision-making dashboards and presentations. Expert using Microsoft Excel, Power BI and SAP.</p>
                        <h4 className="skill-place">Companies I worked with</h4>
