        ...
        <section id="projects">
            ...
            <div className="projects-container">
                <div className="project-container project-1">
                    <a href="https://github.com/estuhub/google-search-react" target="_blank" rel="noreferrer" className="project-link">
                ...
                <div className="project-container project-2">
                    <a href="https://github.com/estuhub/airbnb-mvc" target="_blank" rel="noreferrer" className="project-link">
                        <div className="project-overlay">
                ...
                <div className="project-container project-3">
                    <a href="https://github.com/estuhub/follow-my-trail-react" target="_blank" rel="noreferrer" className="project-link">
                        <div className="project-overlay">
